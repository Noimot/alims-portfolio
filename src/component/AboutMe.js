...
const AboutMe = () => {
  ...
  return (
    <div
      className="w-full bg-light-yellow px-12 lg:px-16 2xl:px-135 dark:bg-[#0C0D0D]"
      id="about-me"
    >
      <div className="hidden l:flex items-center justify-between py-81 border-b border-solid border-light-yellow2 dark:border-[#222324]">
        ...
        <div className="flex items-center gap-x-[3px]">
          ...
          <p className="font-mulish font-semibold text-[#0075FA] text-2xl">
            jeetar
          </p>
        </div>
        <div className="flex items-center gap-x-[3px]">
      ...
      <div className="flex items-center flex-col-reverse l:flex-row justify-center l:justify-between gap-y-[56px] gap-x-88 py-110">
        <aside className="flex-[0.5]">
          <img src={profile} alt="" />
        </aside>
        <aside className="flex-[0.5] flex flex-col gap-y-15">
          <h2 className="uppercase text-orange-1 tracking-[3px] text-base">
            about me
          </h2>
          <h3 className="-tracking-[1px] font-extrabold text-[32px] sm:text-52 leading-[44px] sm:leading-64 dark:text-[#E3E2E0]">
            ...
            {toggle && (
              <>
                <p>
                  ...
                  commerce, healthcare, social life, fintech solution, real
                  estate & more. I have worked with a host of startups solving
                  complex design problems around human needs.
                </p>

                <p>
                  With a background in both agriculture and design, I love
                  connecting the dots between trading, business goals and user
                  satisfaction. In my free time, I enjoy poetry and looking for
                  last minute adventures.
                </p>
              </>
            )}
            <p
              className="text-[#EF6D58] text-opacity-80 block l:hidden cursor-pointer"
          ...
          <div className="flex items-center gap-x-6 pt-15">
            <button
              type="button"
              className="inline-block bg-orange-1 text-white font-semibold text-sm leading-4 rounded-md w-154 h-48 hover:bg-orange-3"
            >
              <a href="https://bit.ly/3AGjRfe" target="_blank">View CV </a>
            </button>
